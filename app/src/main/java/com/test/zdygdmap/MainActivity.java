...
import com.test.zdygdmap.adapter.InfoWinAdapter;
import com.test.zdygdmap.entity.Constant;
import com.test.zdygdmap.utils.CheckPermissionsActivity;
...
//                addMarkerToMap(myLatLng,city,address);
            } else {
